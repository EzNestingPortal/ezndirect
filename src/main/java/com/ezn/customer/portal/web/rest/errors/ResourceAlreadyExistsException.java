...
public class ResourceAlreadyExistsException extends AbstractThrowableProblem {
    ...
    public ResourceAlreadyExistsException(String defaultMessage, String entityName, String errorKey) {
        this(ErrorConstants.DEFAULT_TYPE, defaultMessage, entityName, errorKey);
    }

    public ResourceAlreadyExistsException(URI type, String defaultMessage, String entityName, String errorKey) {
