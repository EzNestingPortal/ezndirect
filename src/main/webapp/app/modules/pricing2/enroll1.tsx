    ...
    let form = (
      <Container className="formContainer">
        <Row className="justify-content-center">
          <Col md="8">
            <h1 id="register-title">One time Registration</h1>
            <h3>Plan={queryString.parse(this.props.location.search).key}</h3>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
                  ...
                  <AvGroup check>
                    <Label>
                      <AvInput
                        ...
                        id="agree"
                      />{" "}
                      I agree to the terms of service, service property details,
              ...
              <Row>
                <Col xs="12" sm="12">
                  <div className="buttonpanel">
                    {/* <Button color="info" type="button" onClick={this.handleBack}>Change Property Details</Button> */}
