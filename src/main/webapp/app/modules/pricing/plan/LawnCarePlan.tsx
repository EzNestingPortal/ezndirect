  ...
  render() {
    ...
    let form = (
      <form onSubmit={this.submithandler}>
        ...
        <div className="ButtonPanel">
          ...
          <Button btnType="btn-primary" clicked={this.proceedToOrder3}>
            ORDER
          </Button>
        </div>
      </form>
    ...
    let details = (
      <div className="PlanContainer">
        <div className="Plan">
          <div className="LawnCircle">
            <h1>${this.props.price2}</h1>
            <h3>Pay Bi-weekly</h3>
          </div>
        </div>
        <div className="LawnPlanType">
          <h1>LAWN CARE</h1>
          <h4>Originally $60</h4>
        </div>
        <div className="PlanDetails">
          <Collapsible
            ...
            triggerClassName="LawnCollapsibleHeader"
            triggerOpenedClassName="LawnCollapsibleHeader"
    ...
    return (
      <div className="PlanContainer">
        {details}
        <div className="LawnPricingBuilder">{form}</div>
      </div>
    );
  }
}
