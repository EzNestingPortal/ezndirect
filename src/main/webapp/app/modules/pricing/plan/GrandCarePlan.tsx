  ...
  render() {
    ...
    let form = (
      <form onSubmit={this.submithandler}>
        ...
        <div className="ButtonPanel">
          ...
          <Button btnType="btn-primary" clicked={this.proceedToOrder2}>
            ORDER
          </Button>
        </div>
      </form>
    ...
    let details = (
      <div className="PlanContainer">
        <div className="Plan">
          <div className="GrandCircle">
            <h1>${this.props.price4}</h1>
            <h3>Pay Bi-weekly</h3>
          </div>
        </div>
        <div className="GrandPlanType">
          <h1>GRAND CARE</h1>
          <h4>Originally $60</h4>
        </div>
        <div className="PlanDetails">
          <Collapsible
            ...
            triggerClassName="GrandCollapsibleHeader"
            triggerOpenedClassName="GrandCollapsibleHeader"
    ...
    return (
      <div className="PlanContainer">
        ...
        <div className="GrandPricingBuilder">{form}</div>
      </div>
    );
  }
}
...
const mapStoreToProps = state => {
  return {
    ...
    price2: state.pricing.price2,
    price3: state.pricing.price3,
    price4: state.pricing.price4
  };
};
