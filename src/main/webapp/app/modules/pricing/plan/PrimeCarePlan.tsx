  ...
  render() {
    ...
    let form = (
      <form onSubmit={this.submithandler}>
        ...
        <div className="ButtonPanel">
          ...
          <Button btnType="btn-primary" clicked={this.proceedToOrder4}>
            ORDER
          </Button>
        </div>
      </form>
    ...
    let details = (
      <div className="PlanContainer">
        <div className="Plan">
          <div className="PrimeCircle">
            <h1>${this.props.price3}</h1>
            <h3>Pay Bi-weekly</h3>
          </div>
        </div>
        <div className="PrimePlanType">
          <h1>PRIME CARE</h1>
          <h4>Originally $60</h4>
        </div>
        <div className="PlanDetails">
          <Collapsible
            ...
            triggerClassName="PrimeCollapsibleHeader"
            triggerOpenedClassName="PrimeCollapsibleHeader"
    ...
    return (
      <div className="PlanContainer">
        {details}
        <div className="PrimePricingBuilder">{form}</div>
      </div>
    );
  }
}
